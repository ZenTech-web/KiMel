  ...
  },
  {
    products: {
      ...
      hamburgueres: [
        { id: 5,  name: "Cachorro Quente", obs: "G", price: 10.00, img: cachorroQuenteImg, opcoes: ["Frango", "Carne"], descricao: "Pão 15cm, salsicha, carne ou frango, salada, ovo de codorna, queijo ralado, cheddar, molho especial e batata palha." },
        { id: 6,  name: "Cachorro Quente", obs: "P", price: 7.00,  img: cachorroQuenteImg, opcoes: ["Frango", "Carne"], descricao: "Pão sedã, salsicha, carne ou frango, salada, queijo ralado, molho especial e batata palha." },
        { id: 10, name: "Mini Hambúrguer", obs: null, price: 10.00, img: hamburger,       descricao: "Mini pão, carne artesanal, presunto, mussarela, molho especial e molho barbecue.", adicionais: [{ nome: "Carne artesanal", preco: 4.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }, { nome: "Salsicha", preco: 2.00 }, { nome: "Ovo", preco: 2.00 }] },
        { id: 11, name: "Tradicional",     obs: null, price: 11.00, img: hamburger,       descricao: "Pão bola, carne tradicional, presunto, mussarela, alface, tomate, molho especial e molho barbecue.", adicionais: [{ nome: "Carne artesanal", preco: 4.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }, { nome: "Salsicha", preco: 2.00 }, { nome: "Ovo", preco: 2.00 }] },
        { id: 12, name: "Burguer",         obs: null, price: 13.00, img: hamburger,       descricao: "Pão bola, carne artesanal, presunto, mussarela, alface, tomate, molho especial e molho barbecue.", adicionais: [{ nome: "Carne artesanal", preco: 4.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }, { nome: "Salsicha", preco: 2.00 }, { nome: "Ovo", preco: 2.00 }] },
        { id: 13, name: "Big",             obs: null, price: 16.00, img: hamburger,       descricao: "Pão bola, 2 carnes artesanais, presunto, mussarela, alface, tomate, molho especial e molho barbecue.", adicionais: [{ nome: "Carne artesanal", preco: 4.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }, { nome: "Salsicha", preco: 2.00 }, { nome: "Ovo", preco: 2.00 }] },
        { id: 14, name: "X-Calabresa",     obs: null, price: 16.00, img: hamburger,       descricao: "Pão bola, carne artesanal, presunto, mussarela, calabresa, alface, tomate, molho especial e molho barbecue.", adicionais: [{ nome: "Carne artesanal", preco: 4.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }, { nome: "Salsicha", preco: 2.00 }, { nome: "Ovo", preco: 2.00 }] },
        { id: 15, name: "X-Bacon",         obs: null, price: 17.00, img: hamburger,       descricao: "Pão bola, carne artesanal, presunto, mussarela, bacon, alface, tomate, molho especial e molho barbecue.", adicionais: [{ nome: "Carne artesanal", preco: 4.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }, { nome: "Salsicha", preco: 2.00 }, { nome: "Ovo", preco: 2.00 }] },
        { id: 16, name: "X-Raiz",          obs: null, price: 19.00, img: xRaizImg,        descricao: "Pão gergelim, carne artesanal, presunto, mussarela, calabresa, salsicha, ovo, alface, tomate, cheddar, molho especial e molho barbecue.", adicionais: [{ nome: "Carne artesanal", preco: 4.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }, { nome: "Salsicha", preco: 2.00 }, { nome: "Ovo", preco: 2.00 }] },
        { id: 17, name: "Supremo",         obs: null, price: 27.00, img: hamburgerSupremo, descricao: "Pão gergelim, 2 carnes artesanais, presunto, mussarela, calabresa, salsicha, frango desfiado, ovo, alface, tomate, cheddar, molho especial e molho barbecue.", adicionais: [{ nome: "Carne artesanal", preco: 4.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }, { nome: "Salsicha", preco: 2.00 }, { nome: "Ovo", preco: 2.00 }] },
      ],
      batata: [
      ...
      tapioca: [
        { id: 21, name: "Tapioca", obs: "1 Sabor",   price: 9.00,  img: tapiocaPlato,  maxSabores: 1, saboresSalgados: ["Frango", "Queijo", "Presunto", "Calabresa", "Ovos"], saboresDoces: ["Coco", "Leite Condensado", "Nutella", "Chocolate", "Morango"], saboresEspeciais: [{ nome: "Charque", preco: 13.00 }], adicionais: [{ nome: "Bacon", preco: 3.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }] },
        { id: 22, name: "Tapioca", obs: "2 Sabores",  price: 11.00, img: tapiocaFrango, maxSabores: 2, saboresSalgados: ["Frango", "Queijo", "Presunto", "Calabresa", "Ovos"], saboresDoces: ["Coco", "Leite Condensado", "Nutella", "Chocolate", "Morango"], saboresEspeciais: [{ nome: "Charque", preco: 13.00 }], adicionais: [{ nome: "Bacon", preco: 3.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }] },
        { id: 23, name: "Tapioca", obs: "3 Sabores",  price: 13.00, img: tapiocaDoce,   maxSabores: 3, saboresSalgados: ["Frango", "Queijo", "Presunto", "Calabresa", "Ovos"], saboresDoces: ["Coco", "Leite Condensado", "Nutella", "Chocolate", "Morango"], saboresEspeciais: [{ nome: "Charque", preco: 13.00 }], adicionais: [{ nome: "Bacon", preco: 3.00 }, { nome: "Cheddar", preco: 2.00 }, { nome: "Catupiry", preco: 2.00 }] },
      ],
      bebidas: [
